...
async def startup_db_client():
    # Dán chuỗi kết nối bạn vừa copy vào đây
    # Thêm 'library_db' vào trước dấu '?' để tạo database tên là library_db
    ...
    # Khởi tạo Beanie với Model Book đã định nghĩa
    await init_beanie(database=client.library_db, document_models=[Book])
    print("--- KẾT NỐI MONGODB ATLAS THÀNH CÔNG ---")python -m uvicorn app:app --reload
